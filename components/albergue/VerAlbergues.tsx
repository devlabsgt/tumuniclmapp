        ...
        <div className="absolute bottom-3 left-3 right-3 z-10">
          <div className="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md rounded-2xl px-4 py-3 shadow-lg border border-white/60 dark:border-neutral-700 flex items-center justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="text-xs font-semibold text-blue-600 dark:text-blue-400 truncate">{seleccionado.lugar}</p>
            </div>
            <button
...
function AccionesRapidas({ a, cardIndex = 0 }: { a: Albergue; cardIndex?: number }) {
  const acciones = [
    { label: 'Maps', icon: <MapPin size={18} />, onClick: () => abrirGoogleMaps(a), className: 'bg-blue-600 hover:bg-blue-700' },
    { label: 'Waze', icon: <Navigation size={18} />, onClick: () => abrirWaze(a), className: 'bg-sky-500 hover:bg-sky-600' },
    { label: 'Llamar', icon: <Phone size={18} />, onClick: () => llamar(a), className: 'bg-slate-700 dark:bg-neutral-700 hover:bg-slate-800 dark:hover:bg-neutral-600' },
    { label: 'WhatsApp', icon: <WhatsAppIcon size={18} />, onClick: () => abrirWhatsApp(a), className: 'bg-emerald-600 hover:bg-emerald-700' },
  ];
...
export default function VerAlbergues() {
  ...
  const lugaresDisponibles = useMemo(
    () => [...new Set(albergues.map((a) => a.lugar))].sort((a, b) => a.localeCompare(b, 'es')),
    []
  );
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 dark:bg-neutral-950">
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 px-4 lg:px-8 pb-6 lg:pb-0 text-white">
        ...
        <div className="relative max-w-lg lg:max-w-none mx-auto flex flex-col items-center text-center gap-3 lg:flex-row lg:items-center lg:text-left lg:gap-6">
          <div className="shrink-0 w-[92%] max-w-[420px] lg:w-auto lg:max-w-none">
            <Image
              ...
              height={380}
              priority
              className="block w-full lg:w-[340px] xl:w-[380px] h-auto object-contain drop-shadow-md"
            />
          </div>
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-2xl lg:text-3xl font-extrabold mt-1 leading-tight">Directorio de Albergues</h1>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          ...
          <div className="lg:sticky lg:top-4 lg:self-start space-y-3">
            ...
            >
              ...
              <div className="relative shadow-md rounded-2xl">
                <MapPin size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-500 pointer-events-none" />
                <select
                  value={lugarFiltro}
            ...
            <motion.div
              ...
              className="w-full rounded-none overflow-hidden shadow-sm bg-white dark:bg-neutral-900"
            >
              ...
              <div className="h-[220px] sm:h-[280px] lg:h-[min(42vw,520px)]">
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <h2 className="font-bold text-base leading-snug dark:text-white">{a.nombre}</h2>
                        ...
                        <p className="text-xs font-semibold text-blue-600 dark:text-blue-400 mt-1">{a.lugar}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-2 w-full flex items-center justify-between gap-3">
                      <p className="text-xs text-gray-500 dark:text-gray-400 min-w-0">
                        {a.encargado ? (
                          <>Encargado: <span className="font-semibold text-gray-700 dark:text-gray-300">{a.encargado}</span></>
                        ) : (
                  ...
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.35, delay: i * 0.04 + 0.15, ease: 'easeOut' }}
