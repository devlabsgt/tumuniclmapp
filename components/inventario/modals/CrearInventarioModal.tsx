...
export default function CrearInventarioModal({ open, onOpenChange, onSuccess }: CrearInventarioModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent aria-describedby={undefined} className="max-w-3xl p-0 m-0 overflow-hidden bg-white dark:bg-neutral-900 border-x sm:border-x border-y-0 border-gray-100 dark:border-neutral-800 flex flex-col h-screen max-h-screen rounded-none">
        ...
        <div className="px-6 pt-0 pb-0 sm:px-8 sm:pt-0 sm:pb-0 flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-3">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 pt-1 sm:px-8 custom-scrollbar pb-2">
          <form onSubmit={handleSubmit(onSubmit as any)}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1.2fr] gap-4 sm:gap-5">
              ...
              <div className="flex flex-col space-y-4">
                ...
                {/* Card: Fotografía */}
                <div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-neutral-800 rounded-2xl p-4 sm:p-5 shadow-sm">
                  <Label className="text-sm font-bold text-slate-800 dark:text-slate-200 block mb-3">Fotografía Inicial (Fábrica)</Label>
