                ...
                <div className="px-6 pt-6 pb-4 sm:px-8 sm:pt-8">
                    ...
                    <div className="flex gap-2 sm:gap-3 justify-center">
                        {[1, 2, 3].map((step) => (
                            <div
                                key={step}
                                className={`h-1.5 rounded-full transition-all duration-500 ${currentStep === step
                        ...
                        {currentStep === 3 && (
                            <div className="space-y-6">
                                <div className="bg-gray-50 dark:bg-neutral-800/40 rounded-2xl p-4 sm:p-6 border border-gray-100 dark:border-neutral-700/50">
                                    ...
                                    <CommissionTable items={comisiones} onChange={setComisiones} isMaquinaria={isMaquinaria} />
                                </div>
