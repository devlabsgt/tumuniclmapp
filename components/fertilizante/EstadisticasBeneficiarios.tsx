        ...
        <div className="p-4 cursor-pointer hover:bg-gray-50" onClick={() => setIsOpen(prev => !prev)}>
          <div className="text-lg font-bold text-green-700">
            <div className="text-sm text-gray-900 mb-5">
              Folios:
              <span className="text-green-700 mx-2">Llenados: {data.filter(b => b.estado === 'Entregado').length},</span>
              ...
              |<span className="text-gray-500 mx-1 underline">Total: {data.length}</span>
            </div>
