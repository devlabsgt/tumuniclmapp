...
import { FileText, Info, PlusCircle, Power } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-2 mb-4">
          ...
          <div className="flex-shrink-0 w-full md:w-auto flex flex-wrap items-center justify-center md:justify-end gap-2">
            ...
            {(rol === 'SUPER' || rol === 'SECRETARIO' || rol === 'SEC-TECNICO') && !isPrinting && !isAgendaFinalizada && (
                <Button 
                  ...
                  className="px-5 py-2 rounded-lg shadow-sm transition-colors flex items-center justify-center space-x-2 bg-purple-500 text-white hover:bg-purple-600 w-full sm:w-auto"
                >
            ...
            {(rol === 'SUPER' || rol === 'SECRETARIO' || rol === 'SEC-TECNICO') && !isPrinting && isAgendaFinalizada && (
                <Button 
                  ...
                  disabled={isPrinting} 
                  className="px-5 py-2 rounded-lg shadow-sm transition-colors flex items-center space-x-2 bg-red-600 text-white hover:bg-red-700 w-full md:w-auto"
                >
                  <FileText size={20} />
      ...
      {agenda && mostrarAvisoAsistencia && (
        <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 px-3 rounded shadow-sm flex items-center justify-center md:justify-start w-full h-10 my-2">
