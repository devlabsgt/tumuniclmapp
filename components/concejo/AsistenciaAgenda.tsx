...
export default function AsistenciaAgenda({ agenda, userId, nombreUsuario, puesto, onAsistenciaMarcada }: AsistenciaAgendaProps) {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-4 border border-gray-300 rounded-lg px-4 py-3 bg-white shadow-sm mb-4 md:mb-0">
        ...
        <div className="w-full md:w-auto">
            {asistenciaCompleta ? (
                ...
                <>
                    {!entradaMarcada ? (
                        <Button 
                            onClick={esTarde ? handleBloqueoPorTiempo : () => handleIniciarMarcado('Entrada')} 
