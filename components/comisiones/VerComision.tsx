  ...
  return (
    <div className="mt-2">
      <div
        onClick={
          tieneRegistros
            ? () => onAbrirMapa(registrosDelAsistente, nombre)
            : undefined
        }
      ...
      >
        <p className="text-gray-800 dark:text-gray-200 font-semibold flex-grow text-xs md:text-sm pb-2">
          {nombre}
        </p>
        ...
        {tieneRegistros ? (
          <div className="flex items-center gap-x-4 text-xs md:text-sm text-gray-700 dark:text-gray-300">
            <p className="font-mono">
              ...
              {formatTime(entrada?.created_at)}
            </p>
            <p className="font-mono">
              <span className="font-semibold">Salida:</span>{" "}
              {formatTime(salida?.created_at)}
            </p>
            {duracionComision && (
