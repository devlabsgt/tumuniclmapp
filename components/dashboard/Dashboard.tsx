  ...
  return (
    <section className="w-full mx-auto px-4 md:px-8 pt-2">
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 mb-6">
        ...
        <ViewSwitcher vistaActiva={vistaActiva} setVistaActiva={setVistaActiva} isSuper={isSuper} />

        <Profile userId={userId} isSuper={isSuper} onShowTarjeta={() => setMostrarTarjetaModal(true)} />
