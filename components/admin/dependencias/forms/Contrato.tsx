...
type RenglonConBono = { salarioLabel: string; bonoLabel: string; tieneBono: true };
type RenglonSinBono = { salarioLabel: string; tieneBono: false };
type RenglonConfig = RenglonConBono | RenglonSinBono;

const renglonConfig: Record<string, RenglonConfig> = {
  '011': { salarioLabel: '011 - Personal permanente', bonoLabel: '015 - Complementos específicos al personal permanente', tieneBono: true },
  '022': { salarioLabel: '022 - Personal por contrato', bonoLabel: '027 - Complementos específicos al personal temporal', tieneBono: true },
  '029': { salarioLabel: '029 - Otras remuneraciones de personal temporal', tieneBono: false },
  '031': { salarioLabel: '031 - Jornales', bonoLabel: '033 - Complementos específicos al personal por jornal', tieneBono: true },
  '035': { salarioLabel: '035 - Retribuciones a destajo', tieneBono: false },
  '036': { salarioLabel: '036 - Retribuciones por servicios', tieneBono: false },
};
