...
const renglonConfig: Record<string, RenglonConfig> = {
  ...
  "061": {
    salarioLabel: "Dietas (061)",
    placeholder: "Monto Dieta",
    tieneBono: false,
  },
  "022": {
  ...
  "035": {
    salarioLabel: "Retribución a destajo (035)",
    placeholder: "Importe",
    tieneBono: false,
  },
  "036": {
...
export default function InfoFinancieraForm({
  isOpen,
  onClose,
  onSubmit,
  dependencia,
  ...
  useEffect(() => {
    if (isOpen && dependencia) {
      ...
      reset({
        renglon: dep.renglon || "",
        salario:
          dep.salario !== null && dep.salario !== undefined
            ? String(dep.salario)
            : "",
        bonificacion:
          dep.bonificacion !== null && dep.bonificacion !== undefined
  ...
  const handleRenglonChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (config) {
      ...
      else if (config.tieneBono && !form.getValues("bonificacion"))
  ...
  const handleFormSubmit: SubmitHandler<FormValues> = (data) => {
    ...
    onSubmit({
      ...
      bonificacion:
        configActual?.tieneBono && data.bonificacion
          ? parseFloat(data.bonificacion)
          : 0,
      unidades_tiempo:
  ...
  const multiplicador =
    configActual?.requiereUnidades && wUnidades ? wUnidades : 1;
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              <h2 className="text-xl text-blue-600 font-bold mb-1">
                          ...
                          <FormControl>
                            ...
                            >
                              ...
                              <optgroup
                                ...
                                className="dark:bg-slate-800"
                              >
                                {Object.entries(nombramientoRenglones).map(
                                  ([k, v]) => (
                                    <option
                                      key={k}
                                      value={k}
                    ...
                    <>
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      handleNumericChange(e, field, true)
                                    }
                                    value={field.value}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem
                            className={
                              configActual.tieneBono ? "" : "md:col-span-2"
                            }
                          >
                            <FormLabel className="text-xs">
                              {configActual.salarioLabel}
                            </FormLabel>
                            <FormControl>
                              <div className="relative">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400">
