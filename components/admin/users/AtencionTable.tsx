...
export default function AtencionTable({ usuarios, rolActual }: Props) {
      ...
      <Transition show={!!usuarioIdSeleccionado} as={Fragment}>
        <Dialog onClose={() => {}} className="relative z-50">
          ...
          <div className="fixed inset-0 flex items-center justify-center p-1 sm:p-4">
            <DialogPanel className="bg-white dark:bg-neutral-900 rounded-lg w-full max-w-4xl p-6 shadow-xl border dark:border-neutral-800">
